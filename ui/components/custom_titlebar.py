...
from PySide6.QtCore import Qt, QSize, QPropertyAnimation, QEasingCurve, QParallelAnimationGroup, QPoint, QRect, QTimer
from PySide6.QtGui import QIcon, QPainter, QBrush, QColor, QPen, QPainterPath, QRegion
...
class CustomTitleBar(QWidget):
    ...
    def _parent_paintEvent(self, event):
        ...
        path = QPainterPath()
        path.addRoundedRect(self.parent_widget.rect().adjusted(1, 1, -1, -1), 12, 12)
    ...
    def apply_rounded_mask(self):
        ...
        try:
            # 创建圆角路径
            path = QPainterPath()
            path.addRoundedRect(self.parent_widget.rect(), 12, 12)
